...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex items-center pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl relative">
          ...
          <h1 
            ref={headingRef}
            className="font-orbitron text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gradient opacity-0 transform translate-y-8 transition-all duration-1000"
          >
          ...
          <div 
            ref={ctaRef}
            className="opacity-0 transition-opacity duration-1000 flex flex-col sm:flex-row gap-4"
          >
            <a 
              href="https://cal.com/securityfortech/"
              target="_blank"
              rel="noopener noreferrer" 
              className="inline-flex items-center justify-center px-8 py-3 font-medium rounded-md relative overflow-hidden group"
            >
            ...
            <a 
              href="#services" 
              className="inline-flex items-center justify-center px-8 py-3 font-medium border border-cyber-primary/50 rounded-md text-cyber-light hover:bg-cyber-primary/10 transition-colors duration-300"
            >
              Explore Services
            </a>
          </div>
