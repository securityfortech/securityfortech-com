    ...
    <section ref={sectionRef} className="relative min-h-screen w-full overflow-hidden flex items-center justify-center pt-16">
      ...
      <div className="container max-w-4xl mx-auto px-4 relative z-10 text-center">
        <div className="relative">
          ...
          <p ref={subheadingRef} className="text-lg md:text-xl font-exo text-cyber-light/90 mb-10 mx-auto max-w-2xl opacity-0 transform translate-y-8 transition-all duration-1000">
